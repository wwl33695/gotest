...
func (this *UASInfo) BuildInviteRequest(rtpport int, channelid string) (request string) {
...
func (this *UASInfo) BuildSDPRequest(rtpport int, ssrc string) (request string) {
